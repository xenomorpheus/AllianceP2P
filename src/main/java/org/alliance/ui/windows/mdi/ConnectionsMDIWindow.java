...
public class ConnectionsMDIWindow extends AllianceMDIWindow {
    ...
    private class ConnectionsTableModel extends AbstractTableModel {
        ...
        public String getColumnName(int columnIndex) {
            switch (columnIndex) {
                case 0:
                    return Language.getLocalizedString(getClass().getEnclosingClass(), "connected");
                case 1:
                    return Language.getLocalizedString(getClass().getEnclosingClass(), "status");
                case 2:
                    return Language.getLocalizedString(getClass().getEnclosingClass(), "sent");
                case 3:
                    return Language.getLocalizedString(getClass().getEnclosingClass(), "received");
                case 4:
                    return Language.getLocalizedString(getClass().getEnclosingClass(), "direction");
                default:
